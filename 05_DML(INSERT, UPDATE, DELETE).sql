...
INSERT INTO EMPLOYEE2 VALUES('900','장채현','901230-2000000','jang_ch@kh.co.kr',
							'01012341234','D1','J7','S3', 4300000, 0.2, 200, SYSDATE, NULL, 'N');

SELECT * FROM EMPLOYEE2 WHERE EMP_ID = '900';

ROLLBACK; -- 윈도우 AUTO COMMIT이 설정되어 있어서 ROLLBACK이 안되고 있었음 
...
SELECT EMP_NAME, BONUS, SALARY  FROM EMPLOYEE2 WHERE EMP_NAME = '유재식';
...
SELECT EMP_NAME, BONUS, SALARY  FROM EMPLOYEE2 WHERE EMP_NAME IN ('유재식','방명수');
