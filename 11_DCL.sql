...
--2. 새 연결(접속 방법) 추가
--ORA-01045: 사용자 BDH_SAMPLE는 CREATE SESSION 권한을 가지고있지 않음; 로그온이 거절되었습니다
								--> 접속 권한
...
-- RESOURCCE : DB 사용을 위한 기본 객체 생성 권한을 묶어둔 ROLE
...
AS SELECT * FROM kh_kjy.EMPLOYEE;
