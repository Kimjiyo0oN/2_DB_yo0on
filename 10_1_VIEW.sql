 ...
 * 			가능한 경우도 있지만
 * 			많은 제약이 따르기 때문에 SELECT 
 * 
 *     [VIEW 생성 방법]
    CREATE [OR REPLACE] [FORCE | NOFORCE] VIEW 뷰이름 [(alias[,alias]...)]   --[FORCE | NOFORCE]강제로 미리 만들어 놓는 거 테이블
    AS subquery																	이 있지 않아도 					
    [WITH CHECK OPTION]	 													 --[(alias[,alias]...)] 컬럼 별칭 
    [WITH READ ONLY];    -- 읽기 전용으로만 사용하겠다 
...
--ORA-01400: NULL을 ("KH_KJY"."DEPT_COPY2"."DEPT_TITLE") 안에 삽입할 수 없습니다
